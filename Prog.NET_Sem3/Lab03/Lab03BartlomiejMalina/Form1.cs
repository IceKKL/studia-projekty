...
namespace Lab03BartlomiejMalina
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            //chmura
            // Definicja punktów chmury
            Point[] points4 =
            {
            new Point(600, 580), new Point(610, 595), new Point(620, 605),
            new Point(635, 610), new Point(650, 605), new Point(660, 595),
            new Point(670, 580), new Point(660, 565), new Point(650, 555),
            new Point(635, 550), new Point(620, 555), new Point(610, 565)
        };

            // Użycie pędzla do wypełnienia kształtu niebieskim kolorem
            Brush blueBrush = new SolidBrush(Color.Blue);

            // Opcjonalne obramowanie chmury
            Pen bluePen = new Pen(Color.Blue, 2);
            g.DrawPolygon(bluePen, points4);
        }
    }
}
